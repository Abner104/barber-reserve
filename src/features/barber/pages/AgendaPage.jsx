...
export default function AgendaPage() {
  ...
  const allBookings = [...new Map([...bookings, ...upcoming].map(b => [b.id, b])).values()];
    ...
    <div>
      ...
      {walkModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.8)", zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}
          ...
          <div style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 20, padding: 24, width: "100%", maxWidth: 480, maxHeight: "90vh", overflowY: "auto" }}
      ...
      {view === "calendar" && (
        <div style={{ marginBottom: 16 }}>
          <BarberCalendar
            bookings={[...upcoming, ...dayBookings]}
            onEventClick={b => setDetailModal(b)}
          />
        </div>
      )}
