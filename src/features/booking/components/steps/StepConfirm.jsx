...
export default function StepConfirm({ slug }) {
  ...
  function validate() {
    ...
    else if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(form.email.trim())) e.email = "Ingresa un email válido";
  ...
  return (
    <div style={{ animation: "fadeUp .4s ease" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 24 }}>
        ...
        <div>
          <label style={{ display: "block", fontSize: 12, color: "var(--text-muted)", marginBottom: 8, fontWeight: 700, letterSpacing: 0.5 }}>TELÉFONO *</label>
        ...
        <div>
          <label style={{ display: "block", fontSize: 12, color: "var(--text-muted)", marginBottom: 8, fontWeight: 700, letterSpacing: 0.5 }}>EMAIL *</label>
